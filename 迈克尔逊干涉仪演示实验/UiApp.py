...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(580, 0, 891, 70))
        font = QtGui.QFont()
        font.setFamily("宋体")
...
"}")
        ...
        self.SpinBox_x.setMaximum(35.0)
        self.SpinBox_x.setSingleStep(0.1)
        self.SpinBox_x.setProperty("value", 15.0)
...
"}")
        ...
        self.SpinBox_d.setMaximum(25.0)
        self.SpinBox_d.setSingleStep(0.1)
        self.SpinBox_d.setProperty("value", 10.0)
...
"margin-bottom:3px;\n"
"}")
        self.SpinBox_n.setDecimals(2)
        self.SpinBox_n.setMinimum(1.0)
        self.SpinBox_n.setMaximum(20.0)
        self.SpinBox_n.setSingleStep(0.01)
        self.SpinBox_n.setProperty("value", 1.0)
...
"}")
        ...
        self.SpinBox_f.setMinimum(15)
        self.SpinBox_f.setMaximum(75.0)
        self.SpinBox_f.setSingleStep(0.1)
        self.SpinBox_f.setProperty("value", 25.0)
...
"}")
        ...
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(500, 90, 72, 1018))
        ...
        self.formLayout_3.setLayout(0, QtWidgets.QFormLayout.FieldRole, self.formLayout_4)
        self.label_I = QtWidgets.QLabel(self.formLayoutWidget_3)
        self.label_I.setMinimumSize(QtCore.QSize(0, 500))
        self.label_I.setMaximumSize(QtCore.QSize(100, 400))
        self.label_I.setObjectName("label_I")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_I)
        self.label_diffraction = QtWidgets.QLabel(self.formLayoutWidget_3)
        self.label_diffraction.setMinimumSize(QtCore.QSize(0, 500))
        self.label_diffraction.setMaximumSize(QtCore.QSize(100, 500))
        self.label_diffraction.setObjectName("label_diffraction")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_diffraction)
...
"}")
        ...
        # self.formLayoutWidget_4.setGeometry(QtCore.QRect(610, 60, 1021, 591))
        ...
        # self.formLayoutWidget_5.setGeometry(QtCore.QRect(610, 680, 1021, 391))
        ...
        self.label_7.setGeometry(QtCore.QRect(580, 70, 890, 46))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(22)
        ...
        self.label_8.setGeometry(QtCore.QRect(1500, 80, 191, 46))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(22)
        ...
        self.label_2.setGeometry(QtCore.QRect(1500, 130, 411, 101))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(18)
        ...
        self.label_3.setGeometry(QtCore.QRect(1500, 300, 411, 111))
        self.label_3.setStyleSheet("background-color:rgb(255, 255, 255)")
        self.label_3.setObjectName("label_3")
        self.label_6 = QtWidgets.QLabel(MainWindow)
        self.label_6.setGeometry(QtCore.QRect(1500, 550, 410, 450))
        self.label_6.setStyleSheet("background-color:rgb(255, 255, 255)")
        self.label_6.setObjectName("label_6")
        self.pushButton_start2 = QtWidgets.QPushButton(MainWindow)
        self.pushButton_start2.setGeometry(QtCore.QRect(1600, 420, 200, 60))
        self.pushButton_start2.setMinimumSize(QtCore.QSize(200, 60))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(16)
        self.pushButton_start2.setFont(font)
        self.pushButton_start2.setStyleSheet("QPushButton {\n"
"    background-color: rgba(0,0,0,20);\n"
"    border: 1px solid #dcdfe6;\n"
"    padding: 10px;\n"
"    border-radius: 15px;\n"
...
"}")
        ...
        self.label_9.setGeometry(QtCore.QRect(1500, 250, 191, 46))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(22)
        ...
        self.label_10.setGeometry(QtCore.QRect(1500, 500, 191, 46))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(22)
        self.label_10.setFont(font)
        self.label_10.setObjectName("label_10")
        self.pushButton_start1 = QtWidgets.QPushButton(MainWindow)
        self.pushButton_start1.setGeometry(QtCore.QRect(1600, 1010, 200, 60))
        self.pushButton_start1.setMinimumSize(QtCore.QSize(200, 60))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(16)
        self.pushButton_start1.setFont(font)
        self.pushButton_start1.setStyleSheet("QPushButton {\n"
"    background-color: rgba(0,0,0,20);\n"
"    border: 1px solid #dcdfe6;\n"
"    padding: 10px;\n"
"    border-radius: 15px;\n"
...
"}")
        ...
        self.label_3.raise_()
        self.label_6.raise_()
        self.pushButton_start2.raise_()
        self.label_9.raise_()
        self.label_10.raise_()
        self.pushButton_start1.raise_()

        self.formLayoutWidget_4 = QtWidgets.QWidget(MainWindow)
        self.formLayoutWidget_4.setGeometry(QtCore.QRect(480, -190, 1081, 1091))
        self.formLayoutWidget_4.setObjectName("formLayoutWidget_4")
        self.formLayout_diffraction = QtWidgets.QFormLayout(self.formLayoutWidget_4)
        self.formLayout_diffraction.setContentsMargins(0, 0, 0, 0)
        self.formLayout_diffraction.setObjectName("formLayout_diffraction")
        ...
        self.label_6.setPixmap(QtGui.QPixmap("img/原理图.png").scaled(410, 450))

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Form"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">迈克尔逊干涉仪演示实验</span></p></body></html>"))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">参数调节区</span></p></body></html>"))
        self.label_d.setText(_translate("MainWindow", "<html><head/><body><p align=\"right\"><span style=\" font-size:20pt;\">距离(mm)</span></p></body></html>"))
        self.label_n.setText(_translate("MainWindow", "<html><head/><body><p align=\"right\"><span style=\" font-size:20pt;\">折射率</span></p></body></html>"))
        self.label_N.setText(_translate("MainWindow", "<html><head/><body><p align=\"right\"><span style=\" font-size:20pt;\">像素n</span></p></body></html>"))
        ...
        self.label_5.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">图像保存区</span></p></body></html>"))
        ...
        self.label_I.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:36pt; font-weight:600;\">光</span></p><p><span style=\" font-size:36pt; font-weight:600;\">强</span></p><p><span style=\" font-size:36pt; font-weight:600;\">分</span></p><p><span style=\" font-size:36pt; font-weight:600;\">布</span></p></body></html>"))
        self.label_diffraction.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:36pt; font-weight:600;\">干</span></p><p><span style=\" font-size:36pt; font-weight:600;\">涉</span></p><p><span style=\" font-size:36pt; font-weight:600;\">图</span></p><p><span style=\" font-size:36pt; font-weight:600;\">像</span></p></body></html>"))
        self.pushButton_exit.setText(_translate("MainWindow", "退出"))
        self.label_7.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">仿真图像区</span></p></body></html>"))
        self.label_8.setText(_translate("MainWindow", "<html><head/><body><p>实验目的</p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:17pt;\">1.了解迈克尔逊干涉仪设计原理;</span></p><p><span style=\" font-size:17pt;\">2.探究迈克尔逊干涉仪呈像规律;</span></p></body></html>"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><img src=\"img/迈克尔逊公式.gif\"/></p></body></html>"))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p><img src=\"img/原理图.png\"/></p></body></html>"))
        self.pushButton_start2.setText(_translate("MainWindow", "详细推导"))
        self.label_9.setText(_translate("MainWindow", "<html><head/><body><p>实验公式</p></body></html>"))
        self.label_10.setText(_translate("MainWindow", "<html><head/><body><p>原理图</p></body></html>"))
        self.pushButton_start1.setText(_translate("MainWindow", "原理演示"))
